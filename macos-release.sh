...
mv ../task-rider/dist/TaskRider.app ${OUTPUT_FOLDER}

# Code Sign
echo "###### TaskRider Code Signing ###############"
...
xcrun altool --notarize-app -f ${ZIPPED_APP_NAME} --primary-bundle-id dev.deskriders.taskrider -u ${USER} -p "@keychain:${KEYCHAIN}"
